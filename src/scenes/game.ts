...
export default class GameScene extends Phaser.Scene {
    ...
    plots!: Map<string, Phaser.GameObjects.Image[]>;
    program!: Program;
    lastUpdate = 0;
    ...
    create() {
        this.plots = new Map<string, Phaser.GameObjects.Image[]>();
        ...
        this.player = new Player(this, this.map.widthInPixels / 2, this.map.heightInPixels / 3.3, "player");
        // this.controls = new Controls(this);

        this.map.setCollisionByExclusion([], true, false, obstaclesLayer!);
        this.physics.add.collider(this.player, obstaclesLayer!);

        this.physics.add.overlap(this.player, interactableLayer!, (player, interactable) => {
